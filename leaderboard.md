...
> 数据：attack 300 / fc 300 / safety 500 / refusal 134（v0.4 种子集，单人标注+CI 担保）。↑越高越好，↓越低越好。
...
|---|---|---|---|
| [attack-bench-zh](https://github.com/uninhibited-Scholar/attack-bench-zh) | 威胁→ATT&CK | 把中文威胁描述映射到技术编号（知识型） | 300 条 |
| [zh-function-calling-bench](https://github.com/uninhibited-scholar/zh-function-calling-bench) | 函数调用 | 简体原生工具调用：函数名+参数+该不该调 | 300 条 |
