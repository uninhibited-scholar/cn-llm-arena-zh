...
| doubao-seed-1.6 | _评测中（API 限流重试）_ | | | | | |
...
## 诚实声明
各基准均为 **v0.4 种子集**（attack 103 / fc 103 / safety 135 / refusal 134，单人标注），分数仅供**方法验证**参考，尚非大规模权威结论；规模化进行中。立场：纯防御 / 评测研究。代码 MIT，数据 CC BY 4.0。
